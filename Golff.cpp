...
//======SAVING SCORECARDS============
    ofstream file("scorecards.txt" , ios::app);             // append mode so old scorecards stay, newer ones dont replace
    file << "Name: " << name << endl;
    file << "Date: " << date << endl;
    file << "Handicap: " << h << endl;
    file << "Score: " << score << endl;        //all information saved
    file << "-------------------------------" << endl;
    file.close();
